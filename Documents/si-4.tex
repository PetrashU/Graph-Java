...
Po uruchomieniu programu wyświela się okno o wymiarach 800 x 600 przedstawiające główny interfejs aplikacji.
...
\begin{itemize}
    ...
    Przycisk wyświetli okienko do wyboru/utworzenia pliku do zapisania obecnego grafu i uruchomi jego zapisywanie w formacie tekstowym.
    \item Przycisk "Save path"
    
    Przycisk wyświetli okienko do wyboru/utworzenia pliku do zapisania wybranych ścieżek i uruchomi zapisywanie w formacie tekstowym.
    \item Przycisk "Clear"
    ...
    Przycisk zainicjuje wywołanie okna z wyborem zakresu kolorów używanych do rysowania ścieżek w grafie. Możliwy będzie wybór koloru oznaczającego wierzchołek o maksmalnym i minimalnym koszcie dojścia, krawędź o największej i najmniejszej wadze oraz kolor używany do rysowania ścieżki.
...
Testy są generowane przy pomocy biblioteki JUnit umożliwiającej przeprowadzanie testów jednostkowych. Testy przechowywane są w folderze \texttt{src/test/java}
